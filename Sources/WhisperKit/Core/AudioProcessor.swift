...
public protocol AudioProcessing {
    ...
    func resumeRecordingLive(inputDeviceID: DeviceID?, saveFile: Bool, filePath: String?, callback: (([Float]) -> Void)?) throws
}
...
public extension AudioProcessing {
    ...
    func resumeRecordingLive(inputDeviceID: DeviceID? = nil, saveFile: Bool = false, filePath: String? = nil, callback: (([Float]) -> Void)?) throws {
        try resumeRecordingLive(inputDeviceID: inputDeviceID, saveFile: saveFile, filePath: filePath, callback: callback)
    }
...
public extension AudioProcessor {
    ...
    func setupEngine(inputDeviceID: DeviceID? = nil, saveFile: Bool, filePath: String?) throws -> AVAudioEngine {
        ...
        if saveFile, let path = filePath, let recordingPath = URL(string: path) {
            ...
            do {
                recordingFile = try AVAudioFile(forWriting: recordingPath,
                                                 settings: settings,
                                                 commonFormat: inputFormat.commonFormat,
                                                 interleaved: inputFormat.isInterleaved)
            } catch {
                Logging.error("Failed to init audio file: \(error)")
            }
        }
    ...
    func resumeRecordingLive(inputDeviceID: DeviceID? = nil, saveFile: Bool = false, filePath: String? = nil, callback: (([Float]) -> Void)? = nil) throws {
        try? setupAudioSessionForDevice()
